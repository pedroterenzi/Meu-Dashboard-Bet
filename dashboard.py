...
# --- ESTILIZAÇÃO CSS PREMIUM (BASEADA NO SEU MODELO) ---
st.markdown("""
    <style>
...
try:
    ...
    if not df_final.empty:
        ...
        # Lógica de Estratégias e Odds (Com correção para Reds)
        ...
        # ---------------------------------------------------------
        # VISÃO 4: JANELAS (REPLICANDO O VISUAL DE ESTRATÉGIA)
        # ---------------------------------------------------------
